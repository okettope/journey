    ...
    return (
        <div>
            ...
            <AboutContent>
                ...
                My latest project, <b>Food n Blog</b>, is a Food/Health Blog/Platform. You can check it out <a rel="noopener noreferrer" target="_blank" href="http://www.google.com">here</a>, or on my <a href="/projects">Project Page</a>. It is being built with React JS and Django.<br/><br/>
